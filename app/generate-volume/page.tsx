...
import { distributeRandomly } from '@/components/instructions/randomgen';
...
import { distributeSOL } from '@/components/instructions/distribute-sol';
...
Component.getLayout = (page: ReactNode) => getHeaderLayout(page, "Volume Generator");
