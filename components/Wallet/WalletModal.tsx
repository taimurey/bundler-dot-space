...
import { UnifiedWalletProvider } from '../../context/UnifiedWalletProvider';
import WalletNotification from './WalletNotification';
import { IUnifiedTheme } from '../../context/UnifiedWalletContext';
import { HARDCODED_WALLET_STANDARDS } from '../../misc/constants';
import { AllLanguage } from '../../context/TranslationProvider/i18n';

const WalletProvider: React.FC<{ theme: IUnifiedTheme; lang: AllLanguage }> = ({ theme, lang }) => {
