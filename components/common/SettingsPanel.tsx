  ...
  return (
    <div>
      <div className="md:hidden border-b border-neutral-700 pb-3 space-y-2 flex-col flex">
        ...
        >
          <p className="text-left solapetext text-white hover:underline focus-visible:outline-none rounded-sm focus-visible:ring-2 focus-visible:ring-custom-green-400 focus-visible:border-none">
            Create Market
          </p>
        </button>
      </div>
      <div className="space-x-4 hidden md:flex items-center">
        ...
        >
          <a className="focus-style px-1 rounded">
            <p className="text-sm text-gray-200 hover:bg-cyan-400 hover:text-white focus-visible:outline-none rounded-full focus-visible:ring-2 focus-visible:ring-cyan-400 focus-visible:border-none px-2 py-1">
              Raydium Liquidity
            </p>
          </a>
        </Link>
      ...
      <div className="space-y-1 my-4 md:mt-2">
        <h3 className="text-sm text-transparent bg-clip-text text-custom-green">
          Program ID
        </h3>
        {!isProgramChanging ? (
          <div className="w-full flex items-center space-x-2 ">
            ...
            <button
              ...
              className="focus-visible:outline-none rounded-sm focus-visible:ring-2 focus-visible:ring-custom-green-400 focus-visible:border-none focus:outline-none"
            >
            ...
            <button
              ...
              className="focus-visible:outline-none rounded-sm focus-visible:ring-2 focus-visible:ring-custom-green-400 focus-visible:border-none"
            >
          ...
          <div className="space-y-2">
            ...
            >
              <input
                ...
                className="flex-1 px-4 py-2 w-full border-custom-green-600 border-b bg-transparent focus:outline-none"
              />
                ...
                {pinnedPrograms.map((programId) => (
                  ...
                  >
                    ...
                    <div onClick={() => unpinProgram(programId)}>
                      <TrashIcon className="h-5 w-5 text-white cursor-pointer hover:text-custom-green-400 transition-all" />
                    </div>
                  </div>
                ))}
              </div>
              ...
              if (cluster.label !== "Custom RPC")
                return (
                  <li
                    ...
                    className={`${isActiveCluster(cluster) ? "bg-custom-green-500" : "bg-custom-green-500"
                      } hover:bg-custom-green-300 p-2 cursor-pointer rounded-md `}
                  >
                    <div>
